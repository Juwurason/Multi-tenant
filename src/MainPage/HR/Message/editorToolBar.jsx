...
export const QuillToolbar = () => (
    <div id="toolbar">
        <span className="ql-formats">
            <select className="ql-font" defaultValue="arial" title="font">
        ...
        <span className="ql-formats">
            <button className="ql-list" value="ordered" title="List-ordered" />
            <button className="ql-list" value="bullet" title="bullet" />
            <button className="ql-indent" value="-1" title="indent-minus" />
            <button className="ql-indent" value="+1" title="indent-plus" />
        </span>
        <span className="ql-formats">
            <button className="ql-script" value="super" title="sup" />
        ...
        <span className="ql-formats">
            ...
            <select className="ql-background" title="text-background" />
        </span>
        <span className="ql-formats">
