...
import { useCompanyContext } from '../../../context';
 ...
 const OtherForms = () => {
     ...
     const FetchSchedule = async () => {
         // setLoading2(true)
         try {
             const { data } = await get(`/Templates/get_other_forms?companyId=${user.companyId}`, { cacheTimeout: 300000 });
            //   console.log(data);
     ...
     const columns = [
         ...
         {
             name: 'Form Name',
             selector: row => row.phone || "Other Forms",
             sortable: true
         },
         {
             name: 'User Created',
     ...
     return (
         <div className="page-wrapper">
             <Helmet>
                 ...
                 <meta name="description" content="Other Forms" />
             </Helmet>
                     ...
                     <div className="row">
                         <div className="col">
                             <ul className="breadcrumb">
                                 ...
                                 <li className="breadcrumb-item active">Other Forms</li>
                             </ul>
                         </div>
                     </div>
                 </div>
