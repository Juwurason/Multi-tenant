...
import { useCompanyContext } from '../../../context';
 ...
 const StaffRegistrar = () => {
     ...
     const columns = [
         ...
         {
             name: 'Form Name',
             selector: row => row.phone || "Staff Registrar",
             sortable: true
         },
         {
             name: 'User Created',
     ...
     return (
         <div className="page-wrapper">
             <Helmet>
                 <title> Staff Registrar</title>
                 <meta name="description" content="Staff Registrar" />
             </Helmet>
                     ...
                     <div className="row">
                         <div className="col">
                             <ul className="breadcrumb">
                                 ...
                                 <li className="breadcrumb-item active">Staff Registrar</li>
                             </ul>
                         </div>
                     </div>
                 </div>
