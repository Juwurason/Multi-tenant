 ...
 */
 ...
 const ClientBehaviuorEdit = () => {
     ...
     const FetchSchedule = async () => {
        // setLoading(true)
        try {
          const {data} = await get(`/BehaviourSupports/${uid}`, { cacheTimeout: 300000 });
          setEditPro(data)
          console.log(data);
    ...
    useEffect(() => {
     ...
     const PostAvail = async (e) => {
         ...
         try {
             ...
             const { data } = await post(`/BehaviourSupports/edit/${uid}`, info);
             console.log(data)
 ...
 export default ClientBehaviuorEdit;