            ...
            cell: (row) => (
                <div className='d-flex flex-column gap-1 p-2' style={{ overflow: 'hidden' }}>
                    ...
                    <span className='d-flex'>
                        <Link to={`/client/app/knowledge-video/${row.knowledgeBaseId}`} className='bg-primary text-white pointer px-2 py-1 rounded d-flex justify-content-center align-items-center'
                            title='View'
    ...
    const ButtonRow = ({ data }) => {
        return (
            <div className="p-2 d-flex gap-1 flex-column " style={{ fontSize: "12px" }}>
              ...
              <div>
                <Link to={`/client/app/knowledge-details/${data.knowledgeBaseId}`}
