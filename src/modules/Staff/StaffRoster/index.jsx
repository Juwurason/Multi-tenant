...
const StaffRoster = () => {
  const [data, setData] = useState([
    {id:"Sunday, March 26, 2023",policyname:"John Doe",description:"Sunday, 26 March 2023 06:25 PM", clockout: "Yemi Keane", department:"06:12 PM", attendance: "",creatat:"1 Jan 2013",status:"Active"},
         {id:"Tuesday, March 07, 2023",policyname:"Richard Miles",description:"Tuesday, 07 March 2023 09:08 AM", clockout: "Dele Ali", department:"12:04 AM", attendance: "", creatat:"18 Mar 2014",status:"Active"},
  ]);
  useEffect( ()=>{
    if($('.select').length > 0) {
      $('.select').select2({
    ...
    const columns = [
      ...
      },
      {
        ...
        sorter: (a, b) => a.attendance.length - b.attendance.length.length,
      },
      {
        title: 'Created',
        dataIndex: 'creatat',
