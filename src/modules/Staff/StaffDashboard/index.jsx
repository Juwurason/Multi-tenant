                                            ...
                                            <div className="card-body">
                                                ...
                                                <ResponsiveContainer width='100%' height={300}>
                                                    ...
                                                    >
                                                        ...
                                                        <Legend />
                                                        <Bar dataKey="Total Income" fill="#18225C" />
                                                        <Bar dataKey="Total Outcome" fill="#DC2626" />
                                                    </BarChart>
                                                </ResponsiveContainer>
                                            ...
                                            <div className="card-body">
                                                ...
                                                <ResponsiveContainer width='100%' height={300}>
                                                    <LineChart data={linechartdata}
                                                        ...
                                                        <Legend />
                                                        <Line type="monotone" dataKey="Total Sales" stroke="#18225C" fill="#00c5fb" strokeWidth={3} dot={{ r: 3 }} activeDot={{ r: 7 }} />
                                                        <Line type="monotone" dataKey="Total Revenue" stroke="#DC2626" fill="#0253cc" strokeWidth={3} dot={{ r: 3 }} activeDot={{ r: 7 }} />
                                                    </LineChart>
                                                </ResponsiveContainer>
