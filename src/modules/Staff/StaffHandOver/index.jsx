...
const StaffHandOver = () => {
    ...
    const FetchSchedule = async () => {
        setLoading(true)
        try {
            const { data } = await get(`/ProgressNotes/handovernote?shiftId=${uid}`, { cacheTimeout: 300000 });
            // console.log(data);
            setClientName(data.profile.fullName);
            setDetails(data);
            setLoading(false);
        } catch (error) {
            // console.log(error);
    ...
    return (
        <>
            <div className="page-wrapper">
                <Helmet>
                    <title>Details Of Progress Note</title>
                    <meta name="description" content="Details Of Progress Note" />
                </Helmet>
                {/* Page Content */}
                    ...
                    <div className="page-header">
                        <div className="row">
                            <div className="col-sm-12">
                                <h3 className="page-title">Details Of Progress Note</h3>
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Details Of Progress Note</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="border-bottom">
                                        <Link to="/staff/staff/progressNote" className="edit-icon bg-danger text-white" >
                                    ...
                                    <ul className="personal-info">
                                        ...
                                        <li>
                                            ...
                                            <div className="text">{details.staff}</div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <div className="text">{moment(details.date).format('lll')}</div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <div className="text">{details.progress}</div>
                                        </li>
                                        <li>
                                            <div className="title">FollowUp</div>
                                            <div className="text">{details.followUp}</div>
                                        </li>
                                        <li>
