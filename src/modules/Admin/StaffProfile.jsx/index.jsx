              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="profile-view">
                        ...
                        <div className="col-md-5">
                          <div className="profile-info-left d-flex flex-column">
                            ...
                            <div className="staff-msg d-flex gap-2">
                              <Link to={`/administrator/editStaffProfile/${staffOne.staffId}`} className="btn btn-primary" >Edit Profile</Link>
                              <Link to={`/administrator/staffDocum/${staffOne.staffId}`} className="btn btn-danger">Staff Doc</Link>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="pro-edit"><Link to={`/administrator/editStaffProfile/${staffOne.staffId}`} className="edit-icon" ><i className="fa fa-pencil" /></Link></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <h4 className="project-title"><Link to="">Office Management</Link></h4>
                ...
                <div className="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <h4 className="project-title"><Link to="">Project Management</Link></h4>
                      <small className="block text-ellipsis m-b-15">
