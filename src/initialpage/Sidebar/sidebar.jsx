        ...
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu" style={{ backgroundColor: "#18225C", height: '100vh' }}>
            ...
            <ul className="sidebar-vertical" id='veritical-sidebar'>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "apps" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "apps" ? "" : "apps")} ><i className="la la-cube" /> <span> Apps</span> <span className="menu-arrow" /></a>
                {isSideMenu == "apps" ?
                  <ul>
                    <li><Link onClick={() => localStorage.setItem("minheight", "true")} to="/conversation/chat">Chat</Link></li>
                    <li className="submenu">
                      <a href="javascript:void(0)" className={level2Menu == "calls" ? "subdrop" : ""} onClick={() => toggleLvelTwo(level2Menu == "calls" ? "" : "calls")}><span> Calls</span> <span className="menu-arrow" /></a>
                      {level2Menu == "calls" ?
                        <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "sales" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "sales" ? "" : "sales")}><i className="la la-files-o" /> <span> Set Up </span> <span className="menu-arrow" /></a>
                {isSideMenu == "sales" ?
                  <ul>
              ...
              */}
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "sales" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "sales" ? "" : "sales")}><i className="la la-files-o" /> <span> Sales </span> <span className="menu-arrow" /></a>
                {isSideMenu == "sales" ?
                  <ul>
                    <li><Link className={pathname.includes('estimates') ? "active" : ""} to="/app/sales/estimates">Estimates</Link></li>
                    <li><Link className={pathname.includes('invoices') ? "active" : ""} to="/app/sales/invoices">Invoices</Link></li>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "accounting" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "accounting" ? "" : "accounting")}><i className="la la-files-o" /> <span> Accounting </span> <span className="menu-arrow" /></a>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "payroll" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "payroll" ? "" : "payroll")}><i className="la la-money" /> <span> Payroll </span> <span className="menu-arrow" /></a>
                {isSideMenu == "payroll" ?
                  <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "reports" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "reports" ? "" : "reports")}><i className="la la-pie-chart" /> <span> Reports </span> <span className="menu-arrow" /></a>
                {isSideMenu == "reports" ?
                  <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "performance" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "performance" ? "" : "performance")}><i className="la la-graduation-cap" /> <span> Performance </span> <span className="menu-arrow" /></a>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "goals" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "goals" ? "" : "goals")}><i className="la la-crosshairs" /> <span> Goals </span> <span className="menu-arrow" /></a>
                {isSideMenu == "goals" ?
                  <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "training" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "training" ? "" : "training")}><i className="la la-edit" /> <span> Training </span> <span className="menu-arrow" /></a>
                {isSideMenu == "training" ?
                  <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "jobs" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "jobs" ? "" : "jobs")}><i className="la la-briefcase" /> <span> Jobs </span> <span className="menu-arrow" /></a>
                {isSideMenu == "jobs" ?
                  <ul>
              ...
              <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "profile" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "profile" ? "" : "profile")}><i className="la la-user" /> <span> Profile </span> <span className="menu-arrow" /></a>
                {isSideMenu == "profile" ?
                  <ul>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "authentication" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "authentication" ? "" : "authentication")} ><i className="la la-key" /> <span> Authentication </span> <span className="menu-arrow" /></a>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "error pages" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "error pages" ? "" : "error pages")}><i className="la la-exclamation-triangle" /> <span> Error Pages </span> <span className="menu-arrow" /></a>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "subscriptions" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "subscriptions" ? "" : "subscriptions")}><i className="la la-hand-o-up" /> <span> Subscriptions </span> <span className="menu-arrow" /></a>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "pages" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "pages" ? "" : "pages")}><i className="la la-columns" /> <span> Pages </span> <span className="menu-arrow" /></a>
                {isSideMenu == "pages" ?
                  <ul>
              ...
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "forms" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "forms" ? "" : "forms")}><i className="la la-object-group" /> <span> Forms </span> <span className="menu-arrow" /></a>
                {isSideMenu == "forms" ?
                  <ul>
              ...
              <li>
                <a href="javascript:void(0)"><i className="la la-file-text" /> <span>Documentation</span></a>
              </li>
              <li>
                <a href=""><i className="la la-info" /> <span>Change Log</span> <span className="badge badge-primary ml-auto">v3.4</span></a>
              </li> */}
              {/* <li className="submenu">
                <a href="javascript:void(0)" className={isSideMenu == "multi Level" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "multi Level" ? "" : "multi Level")}><i className="la la-share-alt" /> <span>Multi Level</span> <span className="menu-arrow" /></a>
                {isSideMenu == "multi Level" ?
                  <ul>
                    <li className="submenu">
                      <a href="javascript:void(0)" className={level2Menu == "level 1" ? "subdrop" : ""} onClick={() => toggleLvelTwo(level2Menu == "level 1" ? "" : "level 1")}> <span>Level 1</span> <span className="menu-arrow" /></a>
                      {level2Menu == "level 1" ?
                        <ul>
                          <li><a href="javascript:void(0)" ><span>Level 2</span></a></li>
                          <li className="submenu">
                            <a href="javascript:void(0)" className={level3Menu == "level 2" ? "subdrop" : ""} onClick={() => toggleLevelThree(level3Menu == "level 2" ? "" : "level 2")}> <span> Level 2</span> <span className="menu-arrow" /></a>
                            {level3Menu == "level 2" ?
                              <ul>
