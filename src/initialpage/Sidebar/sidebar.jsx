        ...
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu">
            ...
            <ul className="sidebar-vertical" id='veritical-sidebar'>
              ...
              <li className="submenu">
                <a href="#" className={isSideMenu == "dashboard" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "dashboard" ? "" : "dashboard")}><i className="la la-dashboard" /> <span> "help me"</span> <span className="menu-arrow" /></a>
                {isSideMenu == "dashboard" ?
                  <ul >
                    <li><Link className={pathname.includes('main/dashboard') ? "active" : ""} to="/app/main/dashboard">Admin Dashboard</Link></li>
                    <li><Link className={pathname.includes('main/employee-') ? "active" : ""}
